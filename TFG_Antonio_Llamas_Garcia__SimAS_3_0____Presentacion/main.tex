...
% \titlegraphic{\includegraphics[height=1.2cm]{../TFG_Antonio_Llamas_Garcia__SimAS_3_0____Manual_Tecnico/img/LogotipoEPSC.pdf}}

\begin{document}

% Transparencia de presentación (similar a portada de manuales)
\input{capitulos/00_Transparencia}
...
\input{capitulos/07_Demostracion}
