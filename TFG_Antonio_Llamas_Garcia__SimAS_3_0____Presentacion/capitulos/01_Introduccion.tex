...
\begin{frame}{Motivación y alcance}
  \begin{itemize}
    ...
    \item El trabajo se centra en el análisis descendente predictivo: eliminación de recursividad y factorización cuando procede, cálculo fiable de Primero/Siguiente y construcción de la tabla predictiva LL(1).
