...
\input{capitulos/03_Antecedentes}
\input{capitulos/04_Restricciones.tex}
\input{capitulos/05_Recursos.tex}

\part{Análisis}
\input{capitulos/06_Especificacion_Requisitos.tex}
\input{capitulos/07_Analisis_Funcional}

\part{Diseño}
\input{capitulos/08_Diseno_de_paquetes}
\input{capitulos/09_Diseno_de_clases}
\input{capitulos/10_Diseno_de_la_interfaz}

\part{Pruebas}
\input{capitulos/11_Pruebas}

\part{Conclusiones y futuras mejoras}
\input{capitulos/12_Conclusiones}
\input{capitulos/13_Futuras_mejoras.tex}
