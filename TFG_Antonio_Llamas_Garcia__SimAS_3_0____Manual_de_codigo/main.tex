...
\input{capitulos/02_Recursos_y_requisitos.tex}
\part{Documentación interna}
\input{capitulos/03_Codigo_de_aplicacion.tex}
\input{capitulos/04_Documentacion_paquetes.tex}
\input{capitulos/05_Sistema_internacionalizacion.tex}
\input{capitulos/06_Compilacion_despliegue.tex}
\input{capitulos/07_Estructura_repositorio.tex}
\input{capitulos/08_Convenciones_mejores_practicas.tex}
